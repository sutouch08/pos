<?php
class Temp_down_payment_invoice_model extends CI_Model
{
  private $tb = "ODPI";
  private $td = "DPI1";
  ...
  {
    $rs = $this->mc
    ->select('U_ECOMNO, ItemCode, Dscription, Quantity, PriceAfVAT')
	...
	{
		return $this->mc->where('DocEntry', $id)->delete($this->td);
	}


	public function delete_temp($id)
	{
		return $this->mc->where('DocEntry', $id)->delete($this->tb);
	}
