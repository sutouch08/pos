...
class Zone_model extends CI_Model
{
  ...
  public function get_warehouse_zone($whsCode = NULL)
  {
    if ($whsCode !== NULL && $whsCode != '')
    {
      $this->db->where('warehouse_code', $whsCode);
    }
  ...
  {
    $rs = $this->ms
      ->select('AbsEntry AS id, BinCode AS code, Descr AS name, SL1Code AS old_code, WhsCode AS warehouse_code, Disabled')
      ->get('OBIN');
