...
<div class="row">
	<div class="col-lg-6 col-md-6 col-sm-6 hidden-xs padding-5">
		<h3 class="title">ออเดอร์กำลังจัด</h3>
	</div>
	<div class="col-xs-12 visible-xs padding-5">
		<h4 class="title-xs">ออเดอร์กำลังจัด</h4>
	</div>
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-5">
		<p class="pull-right top-p">
			<button type="button" class="btn btn-xs btn-warning btn-100" onclick="goBack()"><i class="fa fa-arrow-left"></i> รอจัด</button>
		</p>
	</div>
</div><!-- End Row -->
<hr class=""/>
