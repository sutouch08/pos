...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5">
    ...
    <table class="table table-striped border-1 dataTable" style="min-width:790px;">
      <thead>
				<tr>
...
<?php   foreach($orders as $rs)  : ?>
        ...
        <tr class="font-size-12" id="row-<?php echo $rs->DocEntry; ?>">
          ...
          <td class=""><a href="javascript:void(0)" onclick="get_detail(<?php echo $rs->DocEntry; ?>)"><?php echo $rs->U_ECOMNO; ?></a></td>
					...
					<td class="" ><?php echo empty($rs->F_E_CommerceDate) ? '' : thai_date($rs->F_E_CommerceDate, TRUE); ?></td>
