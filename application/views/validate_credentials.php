		...
		<div class="modal-content">
			...
			<div class="modal-body" id="modal_body">
				<div class="row" style="padding-bottom:15px;">
					<div class="col-sm-12">
						<input type="password" class="form-control input-lg text-center" id="s_key" name="s_key" placeholder="รหัสอนุมัติ" />
						<span class="help-block red text-center not-show" id="sKey-error">xxx</span>
					</div>
