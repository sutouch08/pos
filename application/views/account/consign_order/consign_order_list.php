...
<div class="row">
  ...
  <div class="col-lg-1-harf col-md-1-harf col-sm-1-harf col-xs-6 padding-5">
    ...
    <input type="text" class="form-control input-sm search text-center" name="so_code" id="so_code" value="<?php echo $so_code; ?>" />
  </div>
     ...
     <table class="table table-striped border-1" style="min-width:1250px;">
       <thead>
         <tr class="font-size-12">
           ...
           <th class="min-width-150 text-center">พนักงานขาย</th>
         </tr>
       </thead>
       <tbody>
<?php if(!empty($docs)) : ?>
          ...
          <td class="middle">
            ...
            <?php if($rs->status == 1) : ?>
              <?php if($this->_SuperAdmin) : ?>
                <button type="button" class="btn btn-minier btn-primary" onclick="updateToSap('<?php echo $rs->code; ?>')">USAP</button>
              <?php endif; ?>
            <?php endif; ?>
