...
<div class="row">
	...
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 padding-5 text-right">
		...
		<?php if ($this->permission === TRUE) : ?>
			<button type="button" class="btn btn-white btn-success top-btn" onclick="setPermission()"><i class="fa fa-save"></i> บันทึก</button>
		<?php endif; ?>
	</div>
</div><!-- End Row -->
<hr />
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5">
		<form id="permissionForm" method="post" action="<?php echo $this->home; ?>/set_permission">
			<input type="hidden" name="id_profile" id="id-profile" value="<?php echo $profile->id; ?>" />
			<table class="table table-striped table-bordered table-hover">
				<thead>
					<tr class="hide">
						<th class="min-width-300"></th>
								...
								<?php foreach ($groups['menu'] as $menu) : ?>
									...
									<tr>
										<td class="middle" style="padding-left:20px;"> -
											...
											<input type="hidden" class="x-menu" name="menu[<?php echo $code; ?>]" value="<?php echo $code; ?>" />
										</td>
										<td class="middle text-center">
