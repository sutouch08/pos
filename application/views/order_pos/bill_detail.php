...
<div class="row hidden-xs">
  <div class="col-lg-12 col-md-12 col-sm-12 padding-5 text-right top-p">
    <button type="button" class="btn btn-xs btn-warning" onclick="bill_list()"><i class="fa fa-arrow-left"></i> Back</button>
