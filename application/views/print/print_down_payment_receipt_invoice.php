...
while($total_page > 0 )
{
	...
	$top .= 	'<div class="row" style="margin-left:0px; margin-right:0px;">';
		...
		$top .=     	'<div class="col-sm-10 padding-5">'.$doc->CardCode.'</div>';
		$top .= 		'</div>';
		$top .= 		'<div class="row">';
		$top .=     	'<div class="col-sm-12 padding-5">'.$doc->CardName.'</div>';
		$top .= 		'</div>';
		$top .= 		'<div class="row">';
		...
		$top .= 		'</div>';
		$top .= 		'<div class="row">';
		$top .=     '<div class="col-sm-12 padding-5">โทร.&nbsp;&nbsp;'.$doc->phone.'</div>';
		$top .= 		'</div>';
		$top .= 		'<div class="row">';
		...
		$top .=     	'<div class="col-sm-8 padding-5">'.thai_date($doc->DocDate, FALSE, '/').'</div>';
		$top .= 		'</div>';
		$top .= 		'<div class="row">';
		...
		$top .=     	'<div class="col-sm-8 padding-5">'.$doc->BaseRef.'</div>';
		$top .= 		'</div>';
		$top .= 		'<div class="row">';
		...
		$top .=     	'<div class="col-sm-8 padding-5">'.get_sale_name($doc->SlpCode).'</div>';
		$top .= 		'</div>';
		$top .= 	'</div>';
	$top .=   '</div>';
	$top .= '</div>';
