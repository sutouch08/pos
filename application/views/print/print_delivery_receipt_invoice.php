...
$footer .= 				'</p>';
$footer .= 				'<span style="display:block; height:24px;">&nbsp;</span>';
...
while($total_page > 0 )
{
  ...
  $sub_price .= '</td>';
  $sub_price .= '<td class="middle text-right" style="width:30mm; border:solid 1px #333; border-right:0;  border-bottom:0; padding:3px 8px 3px 8px">';
  ...
  $sub_disc  = '<td style="border:0; border-bottom:solid 1px #333; padding:3px 8px 3px 8px">';
  $sub_disc .=  '<strong>มูลค่าหลังส่วนลด</strong>';
	$sub_disc .=  '<span style="display:block; font-size:8px; margin-top:-4px;">Total After Discount</span>';
  $sub_disc .= '</td>';
  $sub_disc .= '<td class="middle text-right" style="border:solid 1px #333; border-right:0; border-top:0; padding:3px 8px 3px 8px">';
  $sub_disc .=  $totalBfTax;
  $sub_disc .= '</td>';
  array_push($subTotal, array($sub_disc));
