...
<div style="width:<?php echo $pos->paper_size; ?>mm; padding:2px; margin-left:auto; margin-right:auto;">
		<center class="padding-bottom-10 margin-bottom-10 border-bottom-1 font-size-24">เปิดลิ้นชัก</center>
    ...
    <table class="width-100" border="0" align="center" cellpadding="0" cellspacing="0" style="font-size:16px; margin-bottom:10px;" >
			...
			<tr><td class="width-40">วันที่</td><td class="width-60"><?php echo date('d-m-Y H:i:s'); ?></td></tr>
			<tr><td class="width-40">โดย</td><td class="width-60"><?php echo $this->_user->name; ?></td></tr>
