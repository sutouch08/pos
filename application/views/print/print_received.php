<?php
  ...
  $index = 0;
	while($total_page > 0 )
	{
			...
			$page .= $this->printer->content_start();
				...
				if($doc->status == 2)
				{
				  ...
				  <div style="width:0px; height:0px; position:relative; left:30%; line-height:0px; top:300px;color:red; text-align:center; z-index:100000; opacity:0.1; transform:rotate(-45deg)">
				      <span style="font-size:150px; padding:0 20 0 20;">ยกเลิก</span>
				  </div>';
				}
        ...
        {
          $page .= '
				  <div style="width:0px; height:0px; position:relative; left:30%; line-height:0px; top:300px;color:purple; text-align:center; z-index:100000; opacity:0.1; transform:rotate(-45deg)">
				      <span style="font-size:150px; padding:0 20 0 20;">Draft</span>
				  </div>';
        }
