...
$page  = '';
$page .= $this->iprinter->doc_header($doc->code);
...
$thead	= array(
	...
	array("รายละเอียด<span style='display:block;font-size:8px; margin-top:-3px'>Descriptions.</span>", "width:150mm; text-align:center; border:solid 1px #333; border-top:0; border-left:0px;"),
...
$footer  = '<div style="width:190mm; height:44.5mm; margin:auto; outline:solid 1px #333; border-radius:10px;">';
...
$footer .= 				'<strong>ได้รับชำระไว้ถูกต้องแล้ว</strong>';
...
$footer .= 				'<p style="display:inline-block; width:30mm; border-bottom:solid 1px #333; margin-bottom:5px;">&nbsp;</p>
									...
									<p style="display:inline-block; width:7mm; border-bottom:solid 1px #333; margin-bottom:5px; text-align:left;">/</p>
									<p style="display:inline-block; width:7mm; border-bottom:solid 1px #333; margin-bottom:5px; text-align:left;">/</p>';
$footer .= 				'<p class="text-center bold" style="width:35mm; display:inline-block; margin-bottom:5px; font-size:9px;">ผู้รับเงิน/Received By</p>';
...
$footer .= 					'<span style="width:46mm; display:inline-block; font-weight:bold; border-bottom:solid 1px #333; text-align:center">'.number($doc->WhtAmount, 2).'</span>';
$footer .= 				'</p>';
*/
...
while($total_page > 0 )
{
	...
	$top .= 	'<div class="row" style="margin-left:0px; margin-right:0px;">';
		...
		$top .=     	'<div class="col-sm-10 padding-5">'.$doc->customer_code.'</div>';
		$top .= 		'</div>';
		$top .= 		'<div class="row">';
		$top .=     	'<div class="col-sm-12 padding-5">'.$doc->customer_name.'</div>';
		$top .= 		'</div>';
		$top .= 		'<div class="row">';
		$top .=     	'<div class="col-sm-12 padding-5">'.$doc->address.'</div>';
		$top .= 		'</div>';
		$top .= 		'<div class="row">';
		$top .=     	'<div class="col-sm-12 padding-5">'.parseSubDistrict($doc->sub_district, $doc->province).'&nbsp;&nbsp;'.parseDistrict($doc->district, $doc->province).'&nbsp;&nbsp;'.parseProvince($doc->province, ).'&nbsp;&nbsp;'.$doc->postcode.'</div>';
		$top .= 		'</div>';
		$top .= 		'<div class="row">';
		$top .=     '<div class="col-sm-12 padding-5">โทร.&nbsp;&nbsp;'.$doc->customer_phone.'</div>';
		$top .= 		'</div>';
		$top .= 		'<div class="row">';
		...
		$top .=     	'<div class="col-sm-4 padding-5">'.$doc->tax_id.'</div>';
		$top .=     	'<div class="col-sm-3 padding-5">'.$doc->branch_name.'</div>';
		$top .= 		'</div>';
		$top .= 		'<div class="row">';
		...
		$top .=     	'<div class="col-sm-8 padding-5">'.$doc->reference.'</div>';
		$top .= 		'</div>';
		$top .= 		'<div class="row">';
		...
		$top .=     	'<div class="col-sm-8 padding-5">'.get_sale_name($doc->sale_id).'</div>';
		$top .= 		'</div>';
		$top .= 	'</div>';
	$top .=   '</div>';
	$top .= '</div>';
  ...
  {
		$total_vat_amount = number($doc->VatSum, 2);
		$totalBfTax =  number($doc->DocTotal - $doc->VatSum, 2);
		$net_amount = number($doc->DocTotal, 2);
    $remark = "";
  ...
  $subTotal = array();
	...
	//--- ยอดสุทธิ
	$sub_net  = "";
	$sub_net .= '<td class="middle text-center" style="width:110mm; border-top:solid 1px #333; border-bottom-left-radius:10px;"><strong>'.$baht_text.'</strong></td>';
  $sub_net .= '<td style="width:50mm; border-top:solid 1px #333;">';
  ...
  $sub_net .= '</td>';
  $sub_net .= '<td class="middle text-right" style="width:30mm; font-size:14px; border-top:solid 1px #333; border-left:solid 1px #333; border-bottom-right-radius:10px;">';
