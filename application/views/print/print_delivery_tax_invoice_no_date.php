...
$footer .= 				'<span style="display:block;">&nbsp;</span>';
$footer .= 				'<p style="display:inline-block; width:30mm; border-bottom:solid 1px #333;">&nbsp;</p>
									<p style="display:inline-block; width:7mm; border-bottom:solid 1px #333; text-align:left;">&nbsp;</p>
									<p style="display:inline-block; width:7mm; border-bottom:solid 1px #333; text-align:left;">/</p>
									<p style="display:inline-block; width:7mm; border-bottom:solid 1px #333; text-align:left;">/</p>';
$footer .= 				'<p class="text-center bold" style="width:35mm; display:inline-block; font-size:9px;">ผู้รับสินค้า/Goods Received By</p>';
$footer .= 				'<p class="text-center bold" style="width:20mm; display:inline-block; font-size:9px;">วันที่/Date</p>';
$footer .= 				'<span style="display:block;">&nbsp;</span>';
$footer .= 				'<p style="display:inline-block; width:30mm; border-bottom:solid 1px #333;">&nbsp;</p>
									<p style="display:inline-block; width:7mm; border-bottom:solid 1px #333; text-align:left;">&nbsp;</p>
									<p style="display:inline-block; width:7mm; border-bottom:solid 1px #333; text-align:left;">/</p>
									<p style="display:inline-block; width:7mm; border-bottom:solid 1px #333; text-align:left;">/</p>';
$footer .= 				'<p class="text-center bold" style="width:35mm; display:inline-block; font-size:9px;">ผู้ส่งสินค้า/Delivery By</p>';
$footer .= 				'<p class="text-center bold" style="width:20mm; display:inline-block; font-size:9px;">วันที่/Date</p>';
$footer .=      '</td>';
$footer .=      '<td class="text-left" style="width:70mm; border:0; border-right:solid 1px #333;">';
$footer .= 				'<ul style="list-style-type:circle; padding-left:20px; font-size:9.5px; font-weight:bold;">';
$footer .= 					'<li style="padding-bottom:10px;">สินค้านี้ขายขาดไม่รับคืนหรือเปลี่ยน</li>';
$footer .= 					'<li style="padding-bottom:10px;">บริษัทฯ จะนำใบเสร็จรับเงินมาเรียกเก็บเงินในภายหลัง</li>';
$footer .= 					'<li style="padding-bottom:10px;">บริษัทฯ จะคิดดอกเบี้ย 1.25% ต่อเดือน <br/>เมื่อชำระบิลเกินกำหนด</li>';
$footer .= 					'<li style="padding-bottom:10px;">กรุณาชำระเงินด้วยเช็ค ในนามบริษัทฯ <br/>ขีดผู้ถือและขีดคล่อมเท่านั้น</li>';
$footer .= 				'</ul>';
$footer .=      '</td>';
...
while($total_page > 0 )
{
	...
	$top .= 	'<div class="row" style="margin-left:0px; margin-right:0px;">';
		...
		$top .= 		'</div>';
		$top .= 		'<div class="row">';
		$top .=     	'<div class="col-sm-4 padding-5"><span>'.$billLabel.'</span><span style="display:block;font-size:8px; margin-top:-3px;">Sales Order No.</span></div>';
