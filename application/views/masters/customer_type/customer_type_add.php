...
<form class="form-horizontal">
  <div class="form-group margin-top-30">
    ...
    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
      <input type="text" name="code" id="code" class="form-control input-sm e" maxlength="20" value="" autofocus autocomplete="off" />
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
      <input type="text" name="name" id="name" class="form-control input-sm e" maxlength="100" value="" autocomplete="off" />
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-1-harf col-md-2 col-sm-2 col-xs-12">
      <button type="button" class="btn btn-sm btn-success btn-block" onclick="add()"><i class="fa fa-save"></i> Save</button>
    </div>
  </div>
  <input type="hidden" id="id">
</form>

<script src="<?php echo base_url(); ?>scripts/masters/customer_type.js?v=<?php echo date('Ymd'); ?>"></script>
