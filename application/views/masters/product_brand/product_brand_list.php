...
<?php $this->load->view('masters/product_brand/product_brand_control'); ?>
<?php endif; ?>
		...
		<table class="table table-striped tableFixHead dataTable border-1">
			<thead>
				<tr>
					...
					<th class="fix-width-100 sorting <?php echo $sort_user; ?>" id="sort-update_user" onclick="sort('update_user', '<?php echo $sort_user; ?>')">แก้ไขโดย</th>
				</tr>
			</thead>
