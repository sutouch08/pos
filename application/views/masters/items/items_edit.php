...
<div class="row margin-top-30">
  <?php $this->load->view('masters/items/items_edit_left'); ?>
  <?php $this->load->view('masters/items/items_edit_right'); ?>
  ...
  <div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
      <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12">
        <button type="button" class="btn btn-white btn-success btn-100" onclick="update()">
