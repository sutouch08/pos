...
<?php $this->load->view('masters/unit/style'); ?>
...
<form class="form-horizontal margin-top-30">
  <div class="form-group">
    ...
    <div class="col-lg-2 col-md-2-harf col-sm-3 col-xs-12">
      <input type="text" id="code" class="form-control input-sm" maxlength="20" value="<?php echo $unit->code; ?>" autocomplete="off" >
      <input type="hidden" id="id" value="<?php echo $unit->id; ?>">
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
      <input type="text" id="name" class="form-control input-sm" maxlength="100" value="<?php echo $unit->name; ?>" autocomplete="off" autofocus>
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-3 col-md-3-harf col-sm-4 col-xs-12" style="padding-top:7px;">
      <label>
        <input type="radio" class="ace" name="active" value="1" <?php echo $unit->active == 1 ? 'checked' : ''; ?> />
        <span class="lbl">&nbsp; Active &nbsp;&nbsp;</span>
      </label>
      <label class="margin-left-20">
        <input type="radio" class="ace" name="active" value="0" <?php echo $unit->active == 0 ? 'checked' : ''; ?> />
...
<script src="<?php echo base_url(); ?>scripts/masters/unit.js?v=<?php echo date('Ymd'); ?>"></script>
