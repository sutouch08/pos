...
<?php if ($this->pm->can_add) : ?>
  <?php $this->load->view('masters/product_group/product_group_control'); ?>
<?php endif; ?>
...
<script src="<?php echo base_url(); ?>scripts/masters/product_group.js?v=<?php echo date('Ymd'); ?>"></script>
