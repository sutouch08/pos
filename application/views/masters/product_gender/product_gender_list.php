    ...
    <table class="table table-striped tableFixHead dataTable border-1">
      <thead>
        <tr>
          ...
          <th class="fix-width-150 middle text-center sorting <?php echo $sort_update; ?>" id="sort-update_at" onclick="sort('update_at', '<?php echo $sort_update; ?>')">วันที่ปรับปรุง</th>
          <th class="fix-width-150 middle text-center">ผู้ปรับปรุง</th>
        </tr>
      </thead>
