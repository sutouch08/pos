...
<?php if ($this->pm->can_add) : ?>
  <?php $this->load->view('masters/product_main_group/product_main_group_control'); ?>
<?php endif; ?>
...
<?php $sort_updated = get_sort('date_upd', $order_by, $sort_by); ?>
    ...
    <table class="table table-striped tableFixHead dataTable border-1">
      <thead>
        <tr>
          ...
          <th class="fix-width-150 middle text-center sorting <?php echo $sort_updated; ?>" id="sort-date_upd" onclick="sort('date_upd', '<?php echo $sort_updated; ?>')">แก้ไขล่าสุด</th>
