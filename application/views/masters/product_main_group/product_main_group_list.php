...
<?php $sort_updated = get_sort('update_at', $order_by, $sort_by); ?>
    ...
    <table class="table table-striped tableFixHead dataTable border-1">
      <thead>
        <tr>
          ...
          <th class="fix-width-150 middle text-center sorting <?php echo $sort_updated; ?>" id="sort-update_at" onclick="sort('update_at', '<?php echo $sort_updated; ?>')">แก้ไขล่าสุด</th>
