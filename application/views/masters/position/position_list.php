...
<?php if ($this->pm->can_add) : ?>
  <?php $this->load->view('masters/position/position_add_control'); ?>
<?php endif; ?>
    ...
    <table class="table table-striped tableFixHead dataTable border-1">
      <thead>
        <tr>
          ...
          <th class="fix-width-150 sorting <?php echo $sort_update; ?>" id="sort-date_upd" onclick="sort('date_upd', '<?php echo $sort_update; ?>')">ปรับปรุงล่าสุด</th>
          <th class="fix-width-120 sorting <?php echo $sort_user; ?>" id="sort-update_user" onclick="sort('update_user', '<?php echo $sort_user; ?>')">ปรับปรุงโดย</th>
        </tr>
      </thead>
      <tbody id="data-table">
        <?php if (!empty($data)) : ?>
...
<script src="<?php echo base_url(); ?>scripts/masters/position.js?v=<?php echo date('Ymd'); ?>"></script>
