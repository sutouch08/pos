    ...
    <table class="table table-striped tableFixHead dataTable border-1">
      <thead>
        <tr>
          ...
          <th class="fix-width-150 sorting <?php echo $sort_update; ?>" id="sort-update_at" onclick="sort('update_at', '<?php echo $sort_update; ?>')">ปรับปรุงล่าสุด</th>
          <th class="fix-width-120">ปรับปรุงโดย</th>
        </tr>
      </thead>
      <tbody id="data-table">
        <?php if (!empty($data)) : ?>
