...
<?php if ($this->pm->can_add) : ?>
  <?php $this->load->view('masters/product_style/product_style_control'); ?>
<?php endif; ?>
    ...
    <table class="table table-striped tableFixHead dataTable border-1">
      <thead>
        <tr>
          ...
          <th class="fix-width-80 middle text-center sorting <?php echo $sort_member; ?>" id="sort-member" onclick="sort('member', '<?php echo $sort_member; ?>')">สินค้า</th>
          <th class="min-width-100"></th>
          <th class="fix-width-150 middle text-center sorting <?php echo $sort_update; ?>" id="sort-update_at" onclick="sort('update_at', '<?php echo $sort_update; ?>')">แก้ไขล่าสุด</th>
