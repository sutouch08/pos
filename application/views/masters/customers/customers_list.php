...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5 table-responsive">
		<table class="table tableFixHead border-1" style="min-width:1100px;">
			<thead>
				<tr>
					...
					<th class="fix-width-120 middle">กลุ่ม</th>
					<th class="fix-width-120 middle">เกรด</th>
					<th class="fix-width-120 middle">ประเภท</th>
					<th class="fix-width-120 middle">ชนิด</th>
				...
				<?php if (!empty($data)) : ?>
					...
					<?php foreach ($data as $rs) : ?>
						<tr id="row-<?php echo $rs->id; ?>">
							...
							<td class="middle"><?php echo customer_attribute_name($rs->area, $areas); ?></td>
						</tr>
						<?php $no++; ?>
					<?php endforeach; ?>
				<?php endif; ?>
