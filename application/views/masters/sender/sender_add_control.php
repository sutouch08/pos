...
<div class="row margin-top-10">
  ...
  <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 padding-5">
    <div class="input-group">
      ...
      <input type="text" class="form-control input-sm" id="name" maxlength="100" value="" autocomplete="off" />
    </div>
  ...
  <div class="col-lg-2-harf col-md-4 col-sm-4 col-xs-12 padding-5">
    <div class="input-group">
      ...
      <input type="text" class="form-control input-sm" id="phone" maxlength="50" value="" autocomplete="off" />
    </div>
    <div class="error-block" id="phone-error"></div>
  </div>

  <div class="col-lg-1-harf col-md-2 col-sm-2-harf col-xs-4 padding-5 text-center">
  ...
  <div class="col-lg-1-harf col-md-2 col-sm-2-harf col-xs-4 padding-5 text-center">
    <label style="padding-top: 5px; margin-bottom: 0px; height: 30px;" title="ถ้าเลือก ตัวเลือก จะทำให้ผู้ส่งนี้แสดงในรายการเลือกผู้ส่ง">
      <input class="ace ace-switch ace-switch-6" id="show-in-list" type="checkbox" value="1" />
      <span class="lbl">&nbsp; ตัวเลือก <i class="fa fa-question-circle fa-lg grey"></i></span>
    </label>
  </div>
