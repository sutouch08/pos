...
<div class="form-horizontal">
  <div class="form-group margin-top-30">
    ...
    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
      <input type="text" class="form-control input-sm" maxlength="50" id="code" value="" autocomplete="off" autofocus />
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-top-10">
      <label class="fix-width-100">
        <input type="radio" class="ace" name="pickface" value="0" checked />
        <span class="lbl"> No</span>
      </label>
      <label class="fix-width-100">
        <input type="radio" class="ace" name="pickface" value="1" />
  ...
  <div class="form-group">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-top-10">
      <label class="fix-width-100">
        <input type="radio" class="ace" name="fastmove" value="0" checked />
        <span class="lbl"> No</span>
      </label>
      <label class="fix-width-100">
        <input type="radio" class="ace" name="fastmove" value="1" />
        <span class="lbl"> Yes</span>
      </label>
    </div>
  </div>
  ...
  <?php if ($this->pm->can_add) : ?>
    ...
    <div class="form-group">
      <div class="col-lg-9 col-lg-offset-3 col-md-9 col-md-offset-3 col-sm-9 col-sm-offset-3 col-xs-12">
        <button type="button" class="btn btn-white btn-success btn-100" onclick="add()"><i class="fa fa-plus"></i> Add</button>        
      </div>
    </div>
  <?php endif; ?>
</div>
