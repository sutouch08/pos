...
<div class="row margin-top-10">
  <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12 padding-5">
    <div class="input-group">
      ...
      <input type="text" class="form-control input-sm e" id="code" maxlength="10" value="" autocomplete="off" autofocus />
    </div>
  ...
  <div class="col-lg-2-harf col-md-4 col-sm-4 col-xs-12 padding-5">
    <div class="input-group">
      ...
      <input type="text" class="form-control input-sm e" id="name" maxlength="20" value="" autocomplete="off" />
    </div>
    <div class="error-block" id="name-error"></div>
  </div>
  <div class="col-lg-1-harf col-md-2-harf col-sm-2-harf col-xs-12 padding-5">
    <div class="input-group">
      <span class="input-group-addon">อัตรา(%)</span>
      <input type="number" class="form-control input-sm e text-right" id="rate" value="" min="0" max="100" step="0.01" autocomplete="off" />
    </div>
    <div class="error-block" id="rate-error"></div>
  </div>
  <div class="col-lg-1-harf col-md-2-harf col-sm-2-harf col-xs-12 padding-5">
    <div class="input-group">
    ...
    <div class="error-block" id="type-error"></div>
  </div>
...
<script id="new-row-template" type="text/x-handlebarsTemplate">
  <tr id="row-{{id}}">
    ...
    <td class="middle text-center">{{vatType}}</td>
