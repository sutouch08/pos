...
<form class="form-horizontal" id="addForm" method="post" >
  ...
  <div class="form-group">
    ...
    <div class="col-lg-1-harf col-md-1-harf col-sm-1-harf col-xs-12">
			<input type="text" name="position" id="position" class="width-100 req" value="<?php echo $position; ?>" required />
    </div>
    <div class="help-block col-xs-12 col-sm-reset inline red" id="position-error"></div>
  </div>
