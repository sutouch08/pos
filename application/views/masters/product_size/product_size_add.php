...
<?php $this->load->view('masters/product_size/style'); ?>
<div class="row">
...
<hr />
<form class="form-horizontal margin-top-30" id="addForm">
  <div class="form-group">
    ...
    <div class="col-lg-2 col-md-2-harf col-sm-3 col-xs-12">
      <input type="text" id="code" class="form-control input-sm" maxlength="20" value="" autocomplete="off" />
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
      <input type="text" id="name" class="form-control input-sm" maxlength="50" value="" autocomplete="off" />
    </div>
  ...
  <div class="form-group">
    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label no-padding-right">ตำแหน่ง</label>
    <div class="col-lg-1 col-md-1-harf col-sm-1-harf col-xs-12">
      <input type="number" id="position" class="form-control input-sm" value="" />
    </div>
    <div class="help-block col-lg-9 col-lg-offset-3 col-md-9 col-md-offset-3 col-sm-9 col-sm-offset-3" id="position-error"></div>
  </div>
