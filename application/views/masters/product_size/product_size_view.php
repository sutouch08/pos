		...
		<table class="table table-striped table-bordered">
			<thead>
				<tr>
					...
					<th class="fix-width-200 middle">ไซส์</th>
					<th class="fix-width-100 middle text-center">ตำแหน่ง</th>
					<th class="fix-width-100 middle text-center">สินค้า</th>
					...
					<tr>
						...
						<td class="">
							...
							<?php if($this->pm->can_delete) : ?>
								<button type="button" class="btn btn-mini btn-danger" onclick="getDelete('<?php echo $rs->id; ?>', '<?php echo str_replace('"', '&quot;',$rs->name); ?>')">
