...
<div class="row">
  ...
  <div class="col-lg-2 col-md-2-harf col-sm-3 col-xs-6 padding-5">
    ...
    <select class="form-control input-sm" name="group_by" id="group_by">
      <option value="date">แยกตามตามวันที่</option>
      <option value="doc">แยกตามเอกสาร</option>
    </select>
  </div>
...
<script src="<?php echo base_url(); ?>scripts/report/audit/down_payment_summary.js?v=<?php echo date('Ymd'); ?>"></script>
