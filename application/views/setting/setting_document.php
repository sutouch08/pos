<form id="documentForm" method="post" action="<?php echo $this->home; ?>/update_config">
	<div class="row">
		...
		<div class="col-sm-2"><input type="text" class="form-control input-sm input-small text-center prefix" name="PREFIX_ORDER" required value="<?php echo $PREFIX_ORDER; ?>" /></div>
		...
		<div class="col-sm-3"><span class="form-control left-label">ใบสั่งขาย</span></div>
