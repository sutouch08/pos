<div class="modal fade" id="customerModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
	<div class="modal-dialog" style="max-width:500px;">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 padding-5">
						<div class="col-lg-6 col-md-6 col-sm-6 padding-5 first">
							<label>ค้นหาด้วยเบอร์โทร</label>
							<input type="text" class="form-control input-sm text-center" maxlength="20" id="phone-search" placeholder="ค้นหาด้วย เบอร์โทรศัพท์"/>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 padding-5 last">
							<label>ค้นหาด้วยเลขผู้เสียภาษี</label>
							<input type="text" class="form-control input-sm text-center" maxlength="13" id="tax-search" placeholder="ค้นหาด้วย เลขประจำตัวผู้เสียภาษ"/>
						</div>
					</div>
        ...
        <button class="btn btn-success btn-100" onclick="addCustomer()">ตกลง</button>
			</div>
		</div>
	</div>
</div>
