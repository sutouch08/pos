        ...
        <div class="modal-content">
            ...
            <div class="row margin-left-0 margin-right-0">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 padding-5">
                    ...
                    <input type="text" class="form-control input-sm" name="phone" id="adr-phone" placeholder="000 000 0000" />
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 padding-5">
	    ...
	    <div class="modal-content" style="position:relative; max-height:600px; overflow-y:scroll;">
	      ...
	      <div class="modal-body" style="padding-top:0px;">
	        ...
	        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-bottom:15px;">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 middle text-center red" id="payment-error" style="height:30px;"></div>
	          </div><!--/ row -->
	        </div>
	      </div>
	      </div>
