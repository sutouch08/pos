...
<div class='row'>
	<div class='col-lg-12'>
    	<h3 style='margin-bottom:0px;'><i class='fa fa-file-o'></i>&nbsp; <?php echo $this->title; ?></h3>
    </div>
</div><!-- End Row -->
        ...
        <?php 	$id = $rs->id_order; ?>
        		<tr id="row_<?php echo $id; ?>" style="font-size:10px;">
                    ...
                    <td align="right" style="vertical-align:middle;">
                    	<button type="button" class="btn btn-info btn-minier" onclick="print_order(<?php echo $rs->id_order; ?>)" ><i class="fa fa-print"></i> พิมพ์</button>
                    </td>
                </tr>
                <?php $n++; ?>
        <?php endforeach; ?>
...
function print_order(id)
{
	...
	page = "<?php echo base_url(); ?>shop/main/print_order/"+id;
	window.open('<?php echo base_url(); ?>shop/main/print_order/'+id, '_blank', 'width=400, height=600, left='+center+', scrollbars=yes');	
}
