								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger text-center" style="border:none;">
											<?php echo (! empty($message) ? $message : 'รหัสผ่านหมดอายุ คุณต้องเปลี่ยนรหัสผ่านเพื่อเริ่มใช้งานใหม่'); ?>
										</h4>
											...
											<fieldset>
												...
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input type="password" id="current-password" class="form-control" placeholder="รหัสผ่านปัจจุบัน" autofocus required />
												...
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input type="password" id="new-password" class="form-control" placeholder="รหัสผ่านใหม่" required />
														<i class="ace-icon fa fa-lock"></i>
													</span>
												</label>
												...
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input type="password" id="confirm-password" class="form-control" placeholder="ยืนยันรหัสผ่าน" required />
														<i class="ace-icon fa fa-lock"></i>
													</span>
