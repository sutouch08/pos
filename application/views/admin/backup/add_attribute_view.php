...
<form id="data_form" method="post" action="<?php echo $this->home."/add_attribute"; ?>">
...
<div class='col-lg-3 col-lg-offset-4 col-xs-6 col-xs-offset-3'>
    <div class="col-xs-12">
    	<div class="input-group">
            ...
            <input type="text" name="attribute_code" id="attribute_code" class="form-control" placeholder="เช่น WOMEN, AL, 002 เป็นต้น" required="required" autofocus="autofocus" autocomplete="off"  />
        </div>
    </div>
    ...
    <div class="col-xs-12">
    	<div class="input-group">
            ...
            <input type="text" name="attribute_name" id="attribute_name" class="form-control" placeholder="เช่น ผู้หญิง, ผู้ชาย, เล็ก, ใหญ่ เป็นต้น" required="required" autofocus="autofocus" autocomplete="off"  />
        </div>
    </div>
    <div class="col-xs-12">&nbsp;</div>
