...
<form id="data_form" method="post" action="<?php echo $this->home."/edit_size/".$id_size; ?>">
...
<input type="hidden" id="id_size" value="<?php echo $id_size; ?>" />
<div class='row'>
<div class='col-lg-3 col-lg-offset-4 col-xs-6 col-xs-offset-3'>
    <div class="col-xs-12">
    	<div class="input-group">
            ...
            <input type="text" name="size_code" id="size_code" class="form-control" placeholder="เช่น M, L, 002 เป็นต้น" required="required" autofocus="autofocus" autocomplete="off"  value="<?php echo $rs->size_code; ?>" />
        </div>
    </div>
    ...
    <div class="col-xs-12">
    	<div class="input-group">
            ...
            <input type="text" name="size_name" id="size_name" class="form-control" placeholder="เช่น M, L , เล็ก, ใหญ่ เป็นต้น" required="required" autofocus="autofocus" autocomplete="off" value="<?php echo $rs->size_name; ?>"  />
        </div>
    </div>
    <div class="col-xs-12">&nbsp;</div>
