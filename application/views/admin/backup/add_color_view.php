...
<form id="data_form" method="post" action="<?php echo $this->home."/add_color"; ?>">
...
<div class='col-lg-3 col-lg-offset-4 col-xs-6 col-xs-offset-3'>
    <div class="col-xs-12">
    	<div class="input-group">
            ...
            <input type="text" name="color_code" id="color_code" class="form-control" placeholder="รหัสสี เช่น AR, BL, 002 เป็นต้น" required="required" autofocus="autofocus" autocomplete="off"  />
        </div>
    </div>
    ...
    <div class="col-xs-12">
    	<div class="input-group">
            ...
            <input type="text" name="color_name" id="color_name" class="form-control" placeholder="ชื่อสี เช่น ดำ, แดง เป็นต้น" required="required" autofocus="autofocus" autocomplete="off"  />
        </div>
    </div>
    <div class="col-xs-12">&nbsp;</div>
    <div class="col-xs-12">
    	<div class="input-group">
            ...
            <select name="id_color_group" class="form-control"><?php echo selectColorGroup(); ?></select>
        </div>
    </div>
