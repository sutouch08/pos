...
class Order_pos_payment extends PS_Controller
{
  public $menu_code = 'RAPAYM';
	public $menu_group_code = 'RE';
  public $menu_sub_group_code = 'REAUDIT';
	public $title = 'รายงานการรับเงินแยกตามเอกสาร';
  public $filter;
  public function __construct()
  {
    parent::__construct();
    $this->home = base_url().'report/audit/order_pos_payment';
    $this->load->model('report/audit/order_pos_payment_report_model');
    $this->load->helper('shop');    
  }

  public function index()
  {
    $this->load->view('report/audit/report_order_pos_payment');
  }
