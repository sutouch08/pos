...
class Customer_group extends PS_Controller
{
  ...
  public function index()
  {
    $filter = array(
      ...
      'order_by' => get_filter('order_by', 'customer_group_order_by', 'code'),
      'sort_by' => get_filter('sort_by', 'customer_group_sort_by', 'ASC')
    );
  ...
  {
    $filter = ['customer_group_code', 'customer_group_order_by', 'customer_group_sort_by' ];
