...
public function doc_header()
{
	...
	$header .= "	<title>Print Barcode</title>";
	$header .= "	<link href='".base_url()."assets/css/bootstrap.css' rel='stylesheet'>";
	$header .= "	<link href='".base_url()."assets/css/font-awesome.css' rel='stylesheet'>";
	$header .= "	<link href='".base_url()."assets/css/ace-fonts.css' rel='stylesheet'>";
	$header .= "	<link href='".base_url()."assets/css/ace.css' class='ace-main-stylesheet' id='main-ace-style' rel='stylesheet'>";
	$header .= "<link href='".base_url()."assets/css/jquery-ui-1.10.4.custom.min.css' rel='stylesheet'  />";
	$header .= "<script src='".base_url()."assets/js/jquery.min.js'></script>";
	$header .= "<script src='".base_url()."assets/js/jquery-ui-1.10.4.custom.min.js'></script>";
...
public function print_header()
{
	...
	$i	= 0;
	$header = "<div style='width:".$this->content_width."mm; height:".$height."mm; margin:auto; margin-bottom:2mm; border:solid 2px #ccc; border-radius: 10px;' >";
	while(	$i<$r)
	{
		foreach($rd[$i] as $label => $value)
		{
			$header .= "<div style='width:50%; height:10mm; line-height:10mm; float:left; padding-left:10px; '>".$label." : ".$value."</div>";
		}
		$i++;
	}
	$header .= "</div>";
...
public function content_start()
{
	...
	return  "<div style='width:".$this->content_width."mm; height:".$height."mm; margin:auto; margin-bottom:2mm; border:solid 2px #ccc; border-radius: 10px;'>";
}
...
public function print_barcode($barcode, $css = "")
{
	...
	return "<img src='".base_url()."assets/barcode/barcode.php?text=".$barcode."&type=code128' style='".$css."' />";
}
