var HOME = BASE_URL + 'masters/division/';
...
function saveAdd() {
  ...
  let dep_id = $('#add-department-id').val();
  ...
  $.ajax({
    ...
    success:function(rs) {
      if( isJson(rs)) {
        ...
        $('#edit-department-id').val(ds.department_id);
...
function update() {
  ...
  let dep_id = $('#edit-department-id').val();
  ...
  $.ajax({
    ...
    success:function(rs) {
      if( isJson(rs)) {
        ...
        $('#view-department').val(ds.department_name);
